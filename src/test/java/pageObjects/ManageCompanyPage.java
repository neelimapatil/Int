...
/*			Config.logger.info(Config.strOp);
		...
		*/
			objResults.setLogRep(Config.strOp, "PASS", "ClickonNewButton", "Able to click on new button");
		}
		catch(Exception e)
		{
		...
		/*	Config.logger.info(Config.strOp);
			...
			*/
			objResults.setLogRep(Config.strOp, "FAIL", "ClickonNewButton", "Failed to click on new button");
		}
	}
	...
	public void ClickOnSaveButton()
	{
		...
		try
		{
			...
			*/
			objResults.setLogRep(Config.strOp, "PASS", "ClickOnSaveButton", "Able to click on save button");
		}
		catch(Exception e)
		{
			System.out.println(e.getMessage());
...
/*			Config.logger.info(Config.strOp);
			...
			*/
			objResults.setLogRep(Config.strOp, "FAIL", "ClickOnSaveButton", "Unable to click on save button");
		}
	}
